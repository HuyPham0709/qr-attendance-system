...
interface AttendeesScreenProps { user: AuthUser; initialSearch?: string }
...
export function AttendeesScreen({ user, initialSearch = '' }: AttendeesScreenProps) {
